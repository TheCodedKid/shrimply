...
use shrimply_project::project::{AudioSource, ItemAddress};
    ...
    pub fn toggle_tts_generation(
        ...
        runtime.jobs.insert(
            ...
            Job {
                task: Some(task),
                model: model.clone(),
                project_path: shrimply_project::project::active_project_path(),
                presentation: GenerationPresentation {
                    running: true,
                    cancelling: false,
                ...
                match event {
                    ...
                    GenerationEvent::Done(result) => {
                        ...
                        let result = result.and_then(|generation| {
                            if job.project_path != shrimply_project::project::active_project_path()
                            {
