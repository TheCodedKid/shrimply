...
use shrimply_visual_core::transparent_fill::analysis::{self as transparent_fill_analysis, Status};
...
impl InspectorController {
    ...
    pub fn set_transparent_fill_maximum_gap(
        ...
        shrimply_project_document::project::commit_edit(&project, EDIT_COMMIT);
        drop(project);
    ...
    fn transparent_fill_prepared_status(
        ...
        let revision = shrimply_editor_state::player_state::snapshot(&self.player_state).revision;
...
fn transparent_fill_modifier_at<'a>(
    project: &'a shrimply_project_document::project::Project,
