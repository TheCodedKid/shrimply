...
) -> Option<&'a TimelineValue<shrimply_visual_modifiers::dithering::DitheringPattern>> {
...
impl InspectorController {
    pub fn add_dithering_palette_color(
        ...
        shrimply_project_document::project::commit_edit(&project, "add-dithering-palette-color");
        drop(project);
    ...
    pub fn remove_dithering_palette_color(
        ...
        shrimply_project_document::project::commit_edit(&project, "remove-dithering-palette-color");
        drop(project);
        super::refresh(&self.player_state);
        Ok(())
    }
