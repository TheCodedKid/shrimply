...
use shrimply_visual_modifiers::{ModifierEffect, RasterModifierEffect, sampling::SamplingModifier};
...
pub(super) fn is_method(item: &shrimply_project_document::project::VideoItem, path: &str) -> bool {
