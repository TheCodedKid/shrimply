...
fn stroke_end_controls(
    ...
    field: &str,
    label: &str,
    value: &shrimply_project_document::project::PaintStrokeEndOptions,
    runtime: InspectorRuntime,
) {
...
impl InspectorController {
    ...
    fn replace_paint_drawing(
        ...
        self.replace_value_with_commit(
            ...
            Some(shrimply_editor_state::player_state::ProjectChange {
                video: true,
    ...
    fn update_paint(
        ...
        bump_revision(paint)?;
        shrimply_project_document::project::commit_edit(&project, commit);
        drop(project);
