...
use shrimply_project_document::project::{ItemAddress, VideoStabilizationMethod};
...
impl InspectorController {
    ...
    pub fn set_project_name(&self, name: &str) {
        ...
        shrimply_project_document::project::commit_coalesced_edit(&project, "project-name");
        drop(project);
    ...
    pub fn set_video_stream(&self, target: &InspectorTarget, track_id: u32) -> Result<(), String> {
        ...
        shrimply_project_document::project::commit_edit(&project, "video-stream");
        drop(project);
        shrimply_editor_state::player_state::refresh_project(
            &self.player_state,
    ...
    fn set_video_alpha_mask_stream(
        ...
        shrimply_project_document::project::commit_edit(&project, "video-alpha-mask-stream");
        drop(project);
        shrimply_editor_state::player_state::refresh_project(
            &self.player_state,
            crate::refresh::target_change(target, None, true),
    ...
    pub(crate) fn set_video_stabilization_method(
        ...
        shrimply_project_document::project::commit_edit(&project, "video-stabilization-method");
        drop(project);
        shrimply_editor_state::player_state::refresh_project(
            &self.player_state,
            crate::refresh::target_change(target, None, true),
    ...
    fn replace_value(
        ...
        replacement: Value,
        kind: EditKind,
        refresh: Option<shrimply_editor_state::player_state::ProjectChange>,
    ) -> Result<(), String> {
        self.replace_value_with_commit(
            target,
            kind,
