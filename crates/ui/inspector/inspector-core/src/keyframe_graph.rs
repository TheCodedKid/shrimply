...
pub use shrimply_keyframe_graph_skia::*;
...
fn vector_graph<T: shrimply_property_model::timeline_value::TimelineVector>(
    value: &serde_json::Value,
    runtime: crate::InspectorRuntime,
    path: &str,
...
where
    shrimply_property_model::timeline_value::TimelineValue<T>: serde::de::DeserializeOwned,
{
    let timeline: shrimply_property_model::timeline_value::TimelineValue<T> =
