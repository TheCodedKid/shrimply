use shrimply_project_document::project::{
    Background, BackgroundGenerator, BackgroundKind, Color, Time,
};
use shrimply_property_model::timeline_value::{TimelineBool, TimelineStep, TimelineValue};
...
pub(crate) fn integer_graph(
    ...
    let shrimply_property_model::timeline_value::TimelineBase::Keyframes(keyframes) = &value.base
    else {
        return None;
    };
    Some(crate::ScalarGraph {
        ...
        segments: keyframes
            ...
            .map(|pair| crate::GraphSegment {
                ...
                interpolation: shrimply_property_model::timeline_value::Interpolation::KEYFRAME
                    .iter()
