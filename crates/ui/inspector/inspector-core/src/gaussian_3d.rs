...
pub fn clamp_scalar(path: &str, value: f32, projection: CameraProjection) -> f32 {
    match path {
        ...
        CAMERA_F_STOP_PATH => value.clamp(
            shrimply_3dgs_core::MIN_F_STOP,
            shrimply_3dgs_core::MAX_F_STOP,
        ),
        CAMERA_EXPOSURE_PATH => value.clamp(
            shrimply_3dgs_core::MIN_EXPOSURE_EV,
            shrimply_3dgs_core::MAX_EXPOSURE_EV,
        ),
        _ => value,
    }
}
    ...
    InspectorControl::new(ControlKind::LayeredNumber, path, label)
        ...
        .number(NumberSpec {
            ...
            minimum: match kind {
                ...
                ScalarKind::FStop => f64::from(shrimply_3dgs_core::MIN_F_STOP),
                ScalarKind::Exposure => f64::from(shrimply_3dgs_core::MIN_EXPOSURE_EV),
            },
            maximum: match kind {
                ScalarKind::FocalLength => shrimply_3dgs_core::focal_length_mm(1.0),
                ScalarKind::Fov => 179.0,
                ScalarKind::FisheyeFov => 360.0,
                ScalarKind::FStop => f64::from(shrimply_3dgs_core::MAX_F_STOP),
                ScalarKind::Exposure => f64::from(shrimply_3dgs_core::MAX_EXPOSURE_EV),
