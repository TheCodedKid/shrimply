use gtk::prelude::*;
use shrimply_components_gtk::ui::{control_row, enum_dropdown};
use shrimply_project_document::project::Project;
use shrimply_visual_modifiers::{
    ModifierEffect, VectorModifierEffect, text_mask::TextMaskModifier,
};
use uuid::Uuid;
...
fn update(
    ...
    key: Option<&shrimply_project_document::project::ItemAddress>,
    id: Uuid,
    ...
    update(mask);
    shrimply_project_document::project::commit_edit(&project, "edit-text-mask");
}
