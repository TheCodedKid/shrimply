...
use shrimply_visual_modifiers::{ModifierEffect, RasterModifierEffect, mirror::MirrorModifier};
use uuid::Uuid;
...
pub fn add_rows(value: &MirrorModifier, out: &gtk::Box, id: Uuid, context: &InspectorContext) {
    ...
    out.append(&switch_row(
        ...
        move |active| {
            ...
            shrimply_project_document::project::commit_edit(&project, "edit-mirror");
            drop(project);
