...
use gtk::prelude::*;
use shrimply_components_gtk::ui::selector;
use shrimply_visual_modifiers::{ModifierEffect, RasterModifierEffect, crop::CropModifier};
use uuid::Uuid;
    ...
    out.append(&selector(
        ...
        move |percentage| {
            ...
            *crop = if percentage {
            ...
            shrimply_project_document::project::commit_edit(&project, "edit-crop-mode");
            drop(project);
