...
use shrimply_visual_modifiers::{ModifierEffect, RasterModifierEffect, luma_key::LumaKeyModifier};
...
pub fn add_rows(value: &LumaKeyModifier, out: &gtk::Box, id: Uuid, context: &InspectorContext) {
    ...
    out.append(&switch_row("Invert", None, value.invert, move |active| {
        ...
        shrimply_project_document::project::commit_edit(&project, "edit-luma-key-invert");
        drop(project);
