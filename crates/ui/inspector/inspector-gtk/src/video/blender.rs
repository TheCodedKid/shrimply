...
use gtk::glib;
use gtk::prelude::*;
use shrimply_components_gtk::ui::StringSelector;
use shrimply_project_document::project::{Asset, BlenderItem};
...
fn controls(blender: &BlenderItem, source: &Asset, context: &InspectorContext) -> Vec<gtk::Widget> {
    ...
    let binary = shrimply_editor_state::preferences::snapshot(&context.preferences).blender_binary;
