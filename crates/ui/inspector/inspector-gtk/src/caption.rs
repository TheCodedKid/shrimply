...
use adw::prelude::*;
use shrimply_components_gtk::ui::{ColorPicker, MultilineTextInput, switch_row};
...
fn add_text_editor(
    ...
    let editor = MultilineTextInput::builder(text)
        ...
        .on_commit(move || {
            shrimply_project_document::project::commit_edit(&commit_project.borrow(), "caption");
        })
        .build();
...
fn update_caption(
    ...
    update(item);
    shrimply_project_document::project::commit_coalesced_edit(&project, "caption");
    drop(project);
