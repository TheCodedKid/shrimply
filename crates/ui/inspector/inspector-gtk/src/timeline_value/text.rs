...
use shrimply_project_document::project::{Project, TextItem, Time, VideoItemContent};
use uuid::Uuid;
...
pub(crate) fn text_control(
    ...
    .on_commit(move || {
        shrimply_project_document::project::commit_edit(&commit_project.borrow(), TEXT_EDIT_COMMIT);
    })
    .build();
...
fn toggle_keyframes(
    ...
    shrimply_project_document::project::commit_edit(&project, TEXT_KEYFRAME_COMMITS.toggle);
    drop(project);
    refresh(player, true);
    true
}
...
fn toggle_expression(
    ...
    shrimply_project_document::project::commit_edit(&project, TEXT_EXPRESSION_COMMIT);
    drop(project);
    refresh(player, true);
    true
}
...
fn update_expression(
    ...
    shrimply_project_document::project::commit_coalesced_edit(&project, TEXT_EXPRESSION_COMMIT);
    drop(project);
    refresh(player, false);
}
...
fn add_key(
    ...
    shrimply_project_document::project::commit_edit(&project, TEXT_KEYFRAME_COMMITS.add);
    drop(project);
    refresh(player, true);
}
...
fn delete_key(
    ...
    shrimply_project_document::project::commit_edit(&project, TEXT_KEYFRAME_COMMITS.delete);
    drop(project);
    refresh(player, true);
}
...
fn set_interpolation(
    ...
    shrimply_project_document::project::commit_edit(&project, TEXT_KEYFRAME_COMMITS.interpolation);
    drop(project);
    refresh(player, false);
}
...
fn set_text_interpolation(
    ...
    shrimply_project_document::project::commit_edit(
        &project,
        TEXT_KEYFRAME_COMMITS.text_interpolation,
    );
    drop(project);
    refresh(player, false);
}
