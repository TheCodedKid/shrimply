...
pub(super) fn begin_slider_action(
    view: &mut TimelineViewState,
    scrollbar_lifecycle: &mut shrimply_components_skia::slider::Lifecycle,
    x: f64,
    y: f64,
    timeline_width: f64,
    height: f64,
    ...
    let scrollbar = horizontal_scrollbar(
        *view,
        ...
        height,
        duration_seconds,
        shrimply_components_skia::slider::idle_state(),
    );
    ...
    match scrollbar_lifecycle.begin(scrollbar, Vec2::new(x as f32, y as f32), |value| {
        ...
        shrimply_components_skia::slider::Begin::None => (DragMode::None, false),
    }
}
