...
pub struct TimelineInput<'a, 'b> {
    ...
    pub horizontal_scrollbar: Option<shrimply_components_skia::Scrollbar>,
    pub vertical_scrollbar: Option<shrimply_components_skia::Scrollbar>,
...
fn draw_vertical_slider(
    painter: &TimelinePainter,
    scrollbar: Option<shrimply_components_skia::Scrollbar>,
) {
