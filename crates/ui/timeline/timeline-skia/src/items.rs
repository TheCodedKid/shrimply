...
pub use shrimply_timeline_edit::edit::{
...
pub use shrimply_timeline_edit::{ItemKey, TrackKind};
pub use shrimply_timeline_edit::{insert_sorted, next_group_id};
use uuid::Uuid;
...
pub fn track_gap_at(
    ...
    track: TrackKey,
    time: Time,
) -> Option<shrimply_timeline_edit::TrackGap> {
    ...
    Some(shrimply_timeline_edit::TrackGap { track, start, end })
}
