use shrimply_project_document::project::{AlphaMaskShape, VisualAlphaMask};
...
pub fn video_source(
    ...
    stream: u32,
    canvas: shrimply_project_document::project::CanvasSize,
) -> (
    shrimply_project_document::project::VideoItem,
    ...
    let size = shrimply_project_document::project::CanvasSize {
