...
pub(crate) fn draw(
    ...
    if transition.kind == shrimply_project_document::project::VisualTransitionKind::FacetAssembly {
    ...
    for (index, path) in paths.iter().enumerate() {
        ...
        match transition.kind {
            shrimply_project_document::project::VisualTransitionKind::Write if progress < 0.5 => {
