...
pub fn pixel_effect(
    effect: &shrimply_visual_modifiers::RasterModifierEffect,
    evaluation: &VisualEvaluation,
    expressions: &mut TransformExpressionCache,
) -> Option<PixelEffect> {
    use shrimply_visual_modifiers::RasterModifierEffect;
    Some(match effect {
...
pub fn corner_pin(
    effect: &shrimply_visual_modifiers::corner_pin::CornerPinModifier,
    evaluation: &VisualEvaluation,
    expressions: &mut TransformExpressionCache,
