...
impl Renderer {
    ...
    pub fn render(
        ...
        self.encode_compute(
            ...
            shrimply_3dgs_core::shader::SortConstants {
        ...
        for pass in 0..RADIX_PASSES {
            let constants = shrimply_3dgs_core::shader::SortConstants {
                count: uploaded.count,
    ...
    fn encode_compute(
        ...
        constants: shrimply_3dgs_core::shader::SortConstants,
        group_count: u32,
        threads: [usize; 3],
    ...
    fn ensure_uploaded(
        ...
        let gaussians = session
            ...
            .gaussians
            .iter()
            .map(shrimply_3dgs_core::shader::GaussianSource::from_gaussian)
            .collect::<Vec<_>>();
...
fn bind_compute_resources(
    ...
    unsafe {
        ...
        encoder.setBytes_length_atIndex(
            ...
            size_of::<shrimply_3dgs_core::shader::SortConstants>(),
