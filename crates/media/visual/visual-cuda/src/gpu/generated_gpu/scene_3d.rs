...
use ash::vk;
use shrimply_gpu_cuda::{CudaContext, CudaStream, LaunchConfig, sys};
...
pub(super) struct Scene3dRenderer {
    ...
    geometries: HashMap<shrimply_render_3d_core::GeometryIdentity, VulkanGeometry>,
    scenes: HashMap<shrimply_render_3d_core::SceneIdentity, VulkanScene>,
        ...
        let result = (|| {
            ...
            } = rendered
            {
                ...
                let guide_ptr = guides
                    ...
                    .device_ptr;
                let mut output = shrimply_gpu_cuda_memory::global().allocate_buffer::<u32>(
                    stream,
                    pixel_count,
                ...
                {
                    self.optix_denoiser = Some(shrimply_denoise_optix::OptixDenoiser::new(
                        context.clone(),
                        stream,
                        width,
                        height,
                ...
                self.optix_denoiser
                    ...
                    .denoise(
                        stream,
                        shrimply_denoise_optix::DenoiseInputs {
                            beauty: guide_ptr,
                ...
                let toon_color_levels = matches!(
                    ...
                    shrimply_render_3d_core::obj::ShadingModel::Toon
                )
...
impl Scene3dRenderer {
    fn new(owner: &GeneratedGpuRenderer) -> Result<Self, String> {
        ...
        let uniform = VulkanBuffer::new(
            ...
            size_of::<shrimply_render_3d_core::obj::SceneUniforms>() as u64,
    ...
    fn render(
        ...
        {
            let decoded = shrimply_render_3d_core::load_environment(identity.path())
                .map_err(|error| error.to_string())?;
        ...
        let denoise = params.denoising
            && params.shading_model == shrimply_render_3d_core::obj::ShadingModel::Pbr;
        ...
        unsafe {
            ...
            self.vulkan.device.cmd_bind_descriptor_sets(
                ...
                shrimply_render_3d_core::obj::SCENE_DESCRIPTOR_SET,
            ...
            if params.toon_outline_mode != shrimply_render_3d_core::obj::OutlineMode::Off
                && params.toon_outline_method
                    == shrimply_render_3d_core::obj::OutlineMethod::RegionBoundary
            {
    ...
    fn update_descriptors(
        ...
        let buffer = [vk::DescriptorBufferInfo {
            ...
            offset: 0,
            range: size_of::<shrimply_render_3d_core::obj::SceneUniforms>() as u64,
        }];
        ...
        let mut acceleration_write = vk::WriteDescriptorSet::default()
            ...
            .dst_binding(shrimply_render_3d_core::obj::SCENE_ACCELERATION_BINDING)
        ...
        let writes = [
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::SCENE_BINDING)
                .descriptor_type(vk::DescriptorType::UNIFORM_BUFFER)
                .buffer_info(&buffer),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::ENVIRONMENT_TEXTURE_BINDING)
                .descriptor_type(vk::DescriptorType::SAMPLED_IMAGE)
                .image_info(&image),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::ENVIRONMENT_SAMPLER_BINDING)
                .descriptor_type(vk::DescriptorType::SAMPLER)
                .image_info(&sampler),
            acceleration_write,
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::OUTPUT_IMAGE_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&output),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::POSITIONS_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&positions),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::NORMALS_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&normals),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::DENOISER_BEAUTY_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&denoiser_beauty),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::DENOISER_ALBEDO_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&denoiser_albedo),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::DENOISER_NORMAL_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&denoiser_normal),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::DENOISER_BACKGROUND_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&denoiser_background),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::TANGENTS_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&tangents),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::TEX_COORDS_0_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&tex_coords_0),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::TEX_COORDS_1_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&tex_coords_1),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::VERTEX_COLORS_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&colors),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::MESH_MATERIALS_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
                .buffer_info(&materials),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::MATERIAL_TEXTURE_BINDING)
                .descriptor_type(vk::DescriptorType::SAMPLED_IMAGE)
                .image_info(&material_texture),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::MATERIAL_SAMPLER_BINDING)
                .descriptor_type(vk::DescriptorType::SAMPLER)
                .image_info(&material_sampler),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::TRANSMISSION_BACKGROUND_TEXTURE_BINDING)
                .descriptor_type(vk::DescriptorType::SAMPLED_IMAGE)
                .image_info(&transmission_background),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::OUTLINE_GUIDE_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&outline_guide),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::OUTLINE_DISTANCE_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_IMAGE)
                .image_info(&outline_distance),
            vk::WriteDescriptorSet::default()
                .dst_set(self.pipeline.descriptor_set)
                .dst_binding(shrimply_render_3d_core::obj::MESH_INSTANCES_BINDING)
                .descriptor_type(vk::DescriptorType::STORAGE_BUFFER)
...
const _: () = assert!(align_of::<shrimply_render_3d_core::obj::SceneUniforms>() >= 16);
