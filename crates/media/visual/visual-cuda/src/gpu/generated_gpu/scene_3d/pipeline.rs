...
impl ScenePipeline {
    pub(super) fn new(
        ...
        resources.handle = create_ray_tracing_pipeline(
            ...
            resources.layout,
            shrimply_render_3d_core::obj::SPIRV_BYTES,
        )?;
...
fn vulkan_descriptor_type(
    kind: shrimply_render_3d_core::obj::DescriptorKind,
) -> vk::DescriptorType {
    use shrimply_render_3d_core::obj::DescriptorKind;
    match kind {
...
fn create_descriptor_set_layout(device: &ash::Device) -> Result<vk::DescriptorSetLayout, String> {
    ...
    let bindings: Vec<_> = shrimply_render_3d_core::obj::DESCRIPTORS
        .iter()
        .map(|descriptor| {
...
fn create_ray_tracing_pipeline(
    ...
    let stages = [
        vk::PipelineShaderStageCreateInfo::default()
            ...
            .module(module)
            .name(shrimply_render_3d_core::obj::RAYGEN_MAIN_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::RAYGEN_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::OUTLINE_DISTANCE_MAIN_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::RAYGEN_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::OUTLINE_MAIN_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::MISS_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::PRIMARY_MISS_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::MISS_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::SHADOW_MISS_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::CLOSEST_HIT_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::CLOSEST_HIT_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::ANY_HIT_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::ALPHA_ANY_HIT_ENTRY_POINT),
        vk::PipelineShaderStageCreateInfo::default()
            .stage(vk::ShaderStageFlags::ANY_HIT_KHR)
            .module(module)
            .name(shrimply_render_3d_core::obj::SHADOW_ALPHA_ANY_HIT_ENTRY_POINT),
    ];
    let groups = [
...
fn create_descriptor_pool(device: &ash::Device) -> Result<vk::DescriptorPool, String> {
    ...
    let sizes: Vec<_> = kinds
        .into_iter()
        .filter_map(|kind| {
            let descriptor_count = shrimply_render_3d_core::obj::DESCRIPTORS
                .iter()
