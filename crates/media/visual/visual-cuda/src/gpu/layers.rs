use shrimply_gpu_cuda::{CudaStream, sys};

use crate::decode::DecodeControl;
use crate::layer::VideoLayer;
use shrimply_project_document::project::{CanvasSize, VideoSampleMethod};
...
pub(super) struct Anime4kRequest {
    ...
    pub(super) method: shrimply_anime4k_cuda::Method,
    pub(super) scale: f32,
}
...
pub(super) fn prepare(
    ...
    for layer in layers {
        ...
        let method = match sample_method {
            VideoSampleMethod::Anime4k => Some(shrimply_anime4k_cuda::Method::CnnM),
            VideoSampleMethod::Anime4kSrgan => Some(shrimply_anime4k_cuda::Method::SrganUul),
            _ => None,
        };
...
pub(super) fn apply_anime4k(
    ...
    workspace: &mut shrimply_anime4k_cuda::Workspace,
    stream: &std::sync::Arc<shrimply_gpu_cuda::CudaStream>,
) -> Result<Vec<shrimply_gpu_cuda_memory::GpuBuffer<u32>>, String> {
    ...
    for request in &prepared.anime4k {
        ...
        let source = match params.kind {
            LayerKind::Nv12 => shrimply_anime4k_cuda::Source::Nv12 {
            ...
            LayerKind::Rgba => shrimply_anime4k_cuda::Source::Rgba {
