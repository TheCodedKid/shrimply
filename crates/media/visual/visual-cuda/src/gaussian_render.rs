...
impl VisualElement for GaussianElement {
    ...
    fn draw(
        ...
        let mut params = shrimply_visual_core::gaussian::evaluate(
            request.project,
            request.item,
            request.position,
        ...
        if let Some(camera) = shrimply_visual_core::camera_reconstruction::sample_for_visual(
            request.project,
            request.item,
            ...
            shrimply_visual_core::gaussian::apply_tracking(
                &mut params,
                shrimply_visual_core::gaussian::TrackingSample {
