...
use shrimply_visual_core::generated::GeneratedVisual;
use uuid::Uuid;
...
impl VisualElement for PaintElement {
    ...
    fn draw(
        ...
        let prepared = shrimply_visual_core::paint::prepare(
...
struct DeferredPaintFrame(shrimply_visual_core::paint::PreparedPaint);
