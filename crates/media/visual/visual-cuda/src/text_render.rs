...
pub use shrimply_visual_core::text::decoration_outset;
use std::rc::Rc;
use uuid::Uuid;
...
impl VisualElement for TextElement {
    ...
    fn draw(
        ...
        let prepared = shrimply_visual_core::text::prepare(
...
struct DeferredTextFrame(shrimply_visual_core::text::PreparedText);
    ...
    fn rasterize(
        ...
        compositor
            .render_generated_visual(
                self.0.surface_size,
                self.0.canvas_size,
                &shrimply_visual_core::text::MaskedTextFrame {
                    frame: &self.0,
                    masks: &masks,
                },
                &self.0.evaluation,
