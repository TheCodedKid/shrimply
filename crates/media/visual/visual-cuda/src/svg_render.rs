...
use shrimply_gpu_cuda_memory::{ResidentResource, ResourceKey, global as gpu_memory};
pub(crate) use shrimply_visual_core::svg::PreparedSvg;
...
pub struct SvgRenderSession {
    ...
    surface_width: u32,
    surface_height: u32,
    color_overrides: Vec<shrimply_project_document::project::SvgColorOverride>,
}
...
impl GeneratedVisual for DeferredSvgFrame {
    fn draw(
        &self,
        canvas: &Canvas,
        _evaluation: &shrimply_project_evaluation::TransformEvaluation,
        _expressions: &mut shrimply_project_evaluation::TransformExpressionCache,
...
fn svg_source_key(
    snapshot: &AssetSnapshot,
    color_overrides: &[shrimply_project_document::project::SvgColorOverride],
