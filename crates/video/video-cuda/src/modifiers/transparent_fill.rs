...
pub(crate) use shrimply_video_core::transparent_fill::{
    ...
    encode_mask, frame_count, render_input_project, render_position,
    snapped_transparent_fill_position, validate_cache,
};

impl GpuModifier for shrimply_video_core::transparent_fill::ResolvedMask {
