    ...
    F: FnMut(ExportProgress),
{
    ...
    project.validate()?;
    shrimply_video_core::sam2::validate_cache(project)?;
    shrimply_video_core::transparent_fill::validate_cache(project)?;
    ...
    shrimply_video_core::stabilization::ensure_project(project)?;
